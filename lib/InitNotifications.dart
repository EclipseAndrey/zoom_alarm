...
Future<bool>initNotifications(BuildContext context)async {
  ...
  IOSInitializationSettings(
    ...
    onDidReceiveLocalNotification: (id,title,body,payload){return null;},
  );
  ...
  print("Details start "+notificationAppLaunchDetails.didNotificationLaunchApp.toString());


  if(notificationAppLaunchDetails.didNotificationLaunchApp){
    print(notificationAppLaunchDetails.payload);
    goToAlarmPage(context, Note.fromMap(json.decode(notificationAppLaunchDetails.payload)));
    return true;
  }else{
    return false;
  }
...
void goToAlarmPage(BuildContext context, Note note) async{
  ...
  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>PageAlarm(note)));
}